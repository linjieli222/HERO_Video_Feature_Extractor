...
def pyav_decode(
    ...
    try:
        ...
        print("Failed to get video fps/frames_length/duration with exception: {}".format(e))
    ...
    try:
        ...
        print("Failed with get_start_end_idx with exception: {}".format(e))
    ...
    if container.streams.video:
        try:
            ...
            print("Failed  with pyav_decode_stream with exception: {}".format(e))
